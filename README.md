...
در منوی پنل بخش **«بکاپ و بازیابی»** اضافه شده است. بکاپ شامل همه کانفیگ‌ها، میزان مصرف، گروه‌های ساب، UUIDها، کلید عمومی گروه‌ها، هش رمزها و secret پنل است. با ارسال بکاپ، فایل در چت خصوصی تعیین‌شده فرستاده و آخرین نسخه پین می‌شود. پنل تازه در صورت خالی بودن دیتا می‌تواند همین فایل پین‌شده را خودکار بازیابی کند. ربات باید در گروه/کانال مقصد اجازه ارسال فایل و Pin کردن پیام داشته باشد.
