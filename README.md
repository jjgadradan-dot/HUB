...
4. برای اینکه لینک موجود مشتری **بدون ارسال لینک جدید** کار کند، از ابتدا `PUBLIC_BASE_URL` را روی یک دامنه اختصاصی ثابت تنظیم کنید و هنگام مهاجرت فقط DNS همان دامنه را به سرویس جدید ببرید. UUID و مسیر لینک در بکاپ ثابت می‌ماند، ولی دامنه موقت Railway متعلق به سرویس قبلی است و از داخل برنامه قابل انتقال نیست.
