...
| `PUBLIC_BASE_URL` | دامنه اختصاصی ثابت لینک مشتری‌ها، مثل `https://sub.example.com` | — |
...
5. برای اینکه لینک موجود مشتری **بدون ارسال لینک جدید** کار کند، هنگام مهاجرت DNS یا Custom Domain ثبت‌شده را به سرویس جدید ببرید. UUID، مسیر لینک و دامنه در بکاپ ثابت می‌مانند و اپ مشتری فقط همان ساب قبلی را Update می‌کند. دامنه موقت Railway قابل انتقال تضمینی نیست؛ برای مهاجرت واقعی بدون قطعی، دامنه اختصاصی بهترین گزینه است.
